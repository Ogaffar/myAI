...
export const CHAT_HEADER: string = `SportMachine.ai`;
export const MESSAGE_PLACEHOLDER: string = `[MESSAGE PLACEHOLDER]`;
export const FOOTER_MESSAGE: string = `Copyright @ 2025 by Just Gaff`;
export const CLEAR_BUTTON_TEXT: string = `Clear Chat`;
export const PAGE_TITLE: string = `SportMachine.ai`;
