...
export default function ChatHeader({
  ...
  return (
    <div className="z-10 flex justify-center items-center fixed top-0 w-full p-5 bg-gradient-to-b from-transparent to-white shadow-[0_10px_15px_-3px_rgba(255,255,255,1)]">
