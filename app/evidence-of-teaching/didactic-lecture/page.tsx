        ...
        <div className="mx-auto max-w-[1200px] px-6">
          ...
          <AnimatedSection delay={0.1}>
            ...
            >
              ...
              >
                &ldquo;The presenter was very good, able to answer any questions without
                distractions from the audience. Flow and pacing was very good, able to
                communicate effectively.&rdquo;
              </p>
              <cite
                className="font-mono"
                style={{
